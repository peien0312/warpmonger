...
if [[ -z "${DEPLOY_DIRTY:-}" && -n "$(git status --porcelain -- app.py mailer.py payuni.py posdb.py linepay.py linepush.py memberdb.py skeeball.py notify_arrivals.py line_daily.py setup_richmenu.py templates static requirements.txt)" ]]; then
...
tar czf "$TARBALL" \
    ...
    app.py mailer.py payuni.py posdb.py linepay.py linepush.py memberdb.py skeeball.py notify_arrivals.py line_daily.py setup_richmenu.py templates static requirements.txt
